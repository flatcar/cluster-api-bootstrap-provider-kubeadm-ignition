module github.com/flatcar/cluster-api-bootstrap-provider-kubeadm-ignition
...
// TODO: Temporary during development. Remove when required changes are merged in core CAPI.
