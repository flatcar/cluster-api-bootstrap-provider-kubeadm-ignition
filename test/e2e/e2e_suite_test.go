...
var (
	...
	projectImage = "example.com/cluster-api-bootstrap-provider-kubeadm-ignition:v0.0.1"
)
...
func TestE2E(t *testing.T) {
	...
	_, _ = fmt.Fprintf(GinkgoWriter, "Starting cluster-api-bootstrap-provider-kubeadm-ignition integration test suite\n")
